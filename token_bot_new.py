        ...
        try:
            ...
            #TODO оттестить времяфильтр
                ...
                for i in msgs['hits']['hits']:
                    print(i)
                    tb.send_message(my_chat_id, 'чят айди- ' + str(i['_source']['chat_id']))
                ...
                for i in msgs['hits']['hits']:
                    ...
                    for i in sender_msg['hits']['hits']:
                        ...
                        tb.send_message(my_chat_id, 'токены - ' + str(i['_source']['tokenized_msg']))
                         ...
                         my_message.text.lower():
                    my_chat_id = tb.get_updates()[-1].message.chat.id
                    msg_targ = tb.get_updates()[-1].message.text.split('/japanese_search_name@tokenize_sent_bot')[1]
            ...
            # Корейский
            elif my_message.text != 'NoneType' and '/korean_search_name@tokenize_sent_bot' in \
                    my_message.text.lower():
                my_chat_id = tb.get_updates()[-1].message.chat.id
            ...
            elif my_message.text != 'NoneType' and '/russian_search_date@tokenize_sent_bot' in \
                    my_message.text.lower():
                my_chat_id = tb.get_updates()[-1].message.chat.id
